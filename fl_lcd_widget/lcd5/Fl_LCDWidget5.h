// "$Id: Fl_LCDWidget5.h,v 0.0.1  2004/12/12 17:15"
//
...
class Fl_LCDWidget5 : public Fl_Widget {

public :
                                             /*type*//*Value*/
    Fl_LCDWidget5(int, int, int, int, char*, int); // Constructor
    Fl_LCDWidget5(int, int, char*, int); // Constructor
    ~Fl_LCDWidget5();           // Destructor
