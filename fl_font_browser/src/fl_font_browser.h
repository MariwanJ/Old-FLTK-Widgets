...
private:
  ...
  int fontStyle;
  Fl_Color fontColor;
  int fontStrickTrhough;
  int fontUnderLine;
public: 
        void SetFont( int fontname,int fontsyle,int fontsize);
        void SetFontStrickThrough(int DoStrick); // 0 is negative 1 is yes
        void SetFontUnderline(int DoUnderLine);
...
public:
  ...
  Fl_Check_Button *btn_Check1;
  Fl_Check_Button *btn_Check2;
  Fl_Button *btn_Color;
